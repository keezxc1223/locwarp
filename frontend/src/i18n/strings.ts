...
export const STRINGS = {
  ...
  'status.locate_pc_denied': { zh: '電腦拒絕了定位請求, 請到 Windows 設定 → 隱私權 → 位置 把 LocWarp 加進允許清單', en: 'PC denied location access. Go to Windows Settings → Privacy → Location and allow LocWarp.' },
  ...
  'status.locate_pc_source_wifi': { zh: '來源: Wi-Fi 定位', en: 'Source: Wi-Fi positioning' },
