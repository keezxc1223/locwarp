...
# 偵測是否在 py2app bundle 內執行
# bundle 內 __file__ = LocWarp.app/Contents/Resources/locwarp_menubar.py
# 專案根目錄 = LocWarp.app 的上一層
_here = os.path.dirname(os.path.abspath(__file__))
if 'LocWarp.app' in _here:
    ROOT = os.path.dirname(_here)
    while 'LocWarp.app' in ROOT:
